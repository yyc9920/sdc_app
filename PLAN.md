...
Read @direct_comprehension.xlsx , @korean_guide.xlsx and migrate it to one data.csv file.
...
English Sentence,Korean Pronounce,Direct Comprehension
"Hi, Sarah.","하이, 새롸.","안녕 / 사라"
"Hi, David.","하이, 데이빗.","안녕 / 데이빗"
"Good morning.","굿 모어닝.","좋은 / 아침"
...
- Keep it SPA
- Cards: Render sentence cards from data.csv
